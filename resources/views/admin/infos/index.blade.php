...
<div class="container">
    <h1 class="mb-4">
        <i class="fas fa-info-circle"></i> Manage Infos
    </h1>

    <a href="{{ route('dashboard.infos.create') }}" class="btn btn-primary mb-3">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('dashboard.infos.show', $info->id) }}" class="btn btn-info btn-sm mb-1 mb-md-0">
                            <i class="fas fa-eye"></i> View
                        </a>
                        <a href="{{ route('dashboard.infos.edit', $info->id) }}" class="btn btn-warning btn-sm mb-1 mb-md-0">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <form action="{{ route('dashboard.infos.destroy', $info->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this info?');">
